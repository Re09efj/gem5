...
gem5_sim.py
===========
gem5 シミュレーション設定スクリプト。gem5 の内蔵 Python から実行される。
run.py / orchestrator.py がサブプロセスとして呼び出す。直接実行しない。

  gem5.opt -d <output_dir> gem5_sim.py --strategy=Scatter --num-threads=2
                                        --binary=<path> --num-nodes=2
"""
import json
import os
import re
...
# デフォルト設定
# ============================================================
BINARY_PATH = "/home/hiragahama/gem5/ClaudeX/binary/NPB3.4.4/NPB3.4-OMP/bin/cg.S.x"
STRATEGY = "Scatter"
CONCENTRATED_NODE = 0
NUM_NODES = 2
...
L2_ASSOC = 8
REMOTE_LATENCY = "1ns"
DUMMY = "/home/hiragahama/gem5/ClaudeX/binary/tiny_exit"
